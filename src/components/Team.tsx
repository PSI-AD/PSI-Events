  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      <header className="flex justify-between items-end mb-10">
        <div>
          <h2 className="text-3xl font-bold tracking-tight text-slate-900">Team & Attendees</h2>
          <p className="text-slate-500 mt-1">Manage staff profiles and event participation history.</p>
        </div>
        <div className="flex gap-3">
          <button className="flex items-center gap-2 border border-slate-200 bg-white text-slate-900 px-5 py-2.5 rounded-xl font-medium hover:bg-slate-50 transition-all shadow-sm">
