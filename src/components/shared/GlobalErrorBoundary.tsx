    ...
    render() {
        ...
        return (
            <div
                ...
                className="min-h-screen bg-psi-page flex flex-col items-center justify-center px-4 py-12 font-sans"
                role="alert"
                aria-live="assertive"
            >
                ...
                <div className="relative z-10 max-w-lg w-full space-y-6">
                    ...
                    <div className="text-center space-y-2">
                        ...
                        <h1 className="text-psi-primary text-2xl md:text-3xl font-extrabold tracking-tight">
                            System Initialization Error
                        </h1>
                        <p className="text-psi-secondary text-sm leading-relaxed max-w-md mx-auto">
                    ...
                    <div className="bg-psi-surface border border-psi rounded-2xl p-5 space-y-3">
                        ...
                        <details className="group">
                            <summary className="text-xs text-psi-secondary cursor-pointer hover:text-psi-primary list-none flex items-center gap-1 transition-colors">
                                ...
                                {[
                                    ...
                                    return (
                                        <div key={key} className="flex items-center gap-2">
                                            ...
                                            <span className={defined ? 'text-psi-secondary' : 'text-red-300'}>{key}</span>
                                        </div>
                                    );
                                })}
                            </div>
                    ...
                    {error && (
                        <div className="bg-psi-surface border border-psi rounded-2xl overflow-hidden">
                            <button
                                ...
                                className="w-full flex items-center justify-between px-5 py-3 text-xs text-psi-secondary hover:text-psi-primary transition-colors text-left"
                            >
