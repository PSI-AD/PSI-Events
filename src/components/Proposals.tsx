  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 max-w-7xl mx-auto">
      <header className="flex justify-between items-end mb-10">
        <div>
          <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-slate-900 dark:text-white">Proposal Engine</h2>
          <p className="text-slate-500 dark:text-slate-400 mt-1">Generate automated sponsorship pitches and participation offers.</p>
        </div>
        {activeTab !== 'developer' && (
