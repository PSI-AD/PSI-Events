 ...
 * No hardcoded bg-white, bg-slate-900, or bg-slate-800 outside dark: variants.
 */
          ...
          <div className="space-y-6">
            ...
            <div className="psi-card p-8">
              ...
              <div className="space-y-4">
                ...
                <TierInfo tier="Silver" comm="30%" cost="Agent Pays" color="text-slate-400 dark:text-slate-400" />
