          ...
          <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <motion.div whileHover={{ y: -10 }} className="p-8 bg-white border-2 border-amber-500 rounded-[2.5rem] shadow-2xl shadow-amber-500/10 relative overflow-hidden flex flex-col">
              ...
              <div className="mb-8">
                ...
                <p className="text-5xl font-extrabold text-slate-900 mt-6 mb-2">50%</p>
                <p className="text-sm font-bold text-slate-600 uppercase tracking-widest">Commission Split</p>
              </div>
              <div className="space-y-6 flex-1">
                <h3 className="text-xl font-extrabold text-slate-900">Maximum Reward, Zero Branch Risk.</h3>
            ...
            <motion.div whileHover={{ y: -10 }} className="p-8 bg-slate-50 border border-slate-200 rounded-[2.5rem] shadow-lg relative overflow-hidden flex flex-col">
              <div className="mb-8">
                ...
                <p className="text-5xl font-extrabold text-slate-900 mt-6 mb-2">30%</p>
                <p className="text-sm font-bold text-slate-600 uppercase tracking-widest">Commission Split</p>
              </div>
              <div className="space-y-6 flex-1">
            ...
            <motion.div whileHover={{ y: -10 }} className="p-8 bg-slate-900 border border-slate-800 rounded-[2.5rem] shadow-2xl relative overflow-hidden flex flex-col">
              <div className="mb-8">
                ...
                <p className="text-5xl font-extrabold text-white mt-6 mb-2">20%</p>
                <p className="text-sm font-bold text-slate-300 uppercase tracking-widest">Commission Split</p>
              </div>
              <div className="space-y-6 flex-1">
                <h3 className="text-xl font-extrabold text-white">Branch Funded, Maximum Margin.</h3>
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
            ...
            <div className="space-y-10">
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                ...
                <div className="space-y-3">
                  ...
                  <h3 className="text-lg font-extrabold text-white">The Human Trail</h3>
                ...
                <div className="space-y-3">
                  ...
                  <h3 className="text-lg font-extrabold text-white">API Health Monitoring</h3>
                ...
                <div className="space-y-3">
                  ...
                  <h3 className="text-lg font-extrabold text-white">Intrusion Detection</h3>
                ...
                <div className="space-y-3">
                  ...
                  <h3 className="text-lg font-extrabold text-white">Mathematical Failsafes</h3>
