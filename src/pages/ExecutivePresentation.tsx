    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-emerald-500/30">
                ...
                <div className="col-span-2 space-y-6">
                  <div className="h-32 bg-white/5 rounded-2xl border border-white/5 p-6 flex flex-col justify-between">
                    <div className="flex justify-between items-start">
                      <span className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">Branch Gross Profit</span>
                      <TrendingUp size={16} className="text-emerald-500" />
                    </div>
                    <div className="text-3xl font-extrabold text-white">390,000 <span className="text-sm font-normal text-slate-500">AED</span></div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div className="h-24 bg-white/5 rounded-2xl border border-white/5 p-4">
                      <div className="text-[8px] text-slate-500 font-bold uppercase tracking-widest mb-2">Diluted Target</div>
                      <div className="text-xl font-extrabold text-white">75 <span className="text-[10px] font-normal text-slate-500">Leads/Agent</span></div>
                    </div>
                    <div className="h-24 bg-white/5 rounded-2xl border border-white/5 p-4">
                      <div className="text-[8px] text-slate-500 font-bold uppercase tracking-widest mb-2">Sponsorship</div>
                      <div className="text-xl font-extrabold text-emerald-400">150k <span className="text-[10px] font-normal text-slate-500">AED</span></div>
                    </div>
                  </div>
                </div>
                <div className="col-span-1 bg-white/5 rounded-2xl border border-white/5 p-6 flex flex-col justify-between">
                  <div className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">Lead Funnel</div>
                  ...
                  <div className="text-center text-[10px] text-slate-500 font-bold">104% Target Reached</div>
                </div>
              </div>
            </div>
            {/* Glow effect */}
      ...
      <Section className="bg-white">
        <div className="text-center mb-20 space-y-4">
          ...
          <p className="text-xl text-slate-500 font-medium">Why spreadsheets are the enemy of enterprise growth.</p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <ul className="space-y-6">
              {[
                { icon: <Database className="text-slate-400" />, text: "Manual Spreadsheets & Email Chains" },
                { icon: <Activity className="text-slate-400" />, text: "Opaque ROI & Untracked Expenses" },
                { icon: <Users className="text-slate-400" />, text: "WhatsApp-based Approvals" },
                { icon: <Target className="text-slate-400" />, text: "Static, Unrealistic Lead Targets" },
                { icon: <Clock className="text-slate-400" />, text: "Missing Visas & Last-Minute Chaos" }
              ].map((item, i) => (
                <li key={i} className="flex items-center gap-4 text-slate-400 line-through opacity-60">
          ...
          >
            ...
            <ul className="space-y-6">
              {[
                { icon: <Cloud className="text-emerald-400" />, text: "Automated CRM & Maps Sync" },
                { icon: <ShieldCheck className="text-emerald-400" />, text: "Forced Digital Approval Gates" },
                { icon: <TrendingUp className="text-emerald-400" />, text: "Real-Time P&L & GP Calculation" },
                { icon: <Cpu className="text-emerald-400" />, text: "Serverless Target Dilution Math" },
                { icon: <Globe className="text-emerald-400" />, text: "Centralized Logistics Chokepoint" }
              ].map((item, i) => (
      ...
      <Section className="bg-slate-50">
        <div className="text-center mb-20 space-y-4">
          ...
          <p className="text-xl text-slate-500 font-medium">A deterministic workflow where no agent sells without clearance.</p>
        </div>
              ...
              >
                <div className="flex-1 text-center lg:text-left">
                  ...
                  <h3 className="text-3xl font-extrabold text-slate-900 mb-4">
                    <span className="text-slate-300 mr-2">{item.step}</span> {item.title}
                  </h3>
                  ...
                  {item.math && (
                    <div className="mt-6 p-4 bg-white rounded-2xl border border-slate-200 inline-block">
                      <code className="text-amber-600 font-extrabold text-xl">{item.math}</code>
                      <span className="ml-2 text-xs text-slate-400 font-bold uppercase tracking-widest">Leads/Agent</span>
                    </div>
                  )}
                </div>
      ...
      <Section className="bg-white">
        <div className="text-center mb-20 space-y-4">
          ...
          <p className="text-xl text-slate-500 font-medium">Empowering every layer of PSI with automation and security.</p>
        </div>
            ...
            >
              ...
              <div className="relative z-10 space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-slate-500 group-hover:text-white/80 transition-colors font-medium leading-relaxed">
                    {card.desc}
                  </p>
                </div>
              </div>
              ...
              <div className="relative z-10 mt-12 pt-6 border-t border-slate-200 group-hover:border-white/20">
                <p className="text-[10px] uppercase tracking-widest text-slate-400 group-hover:text-white/60 font-bold mb-1">Key Impact</p>
      ...
      <Section className="bg-slate-50">
        <div className="text-center mb-20 space-y-4">
          ...
          <p className="text-xl text-slate-500 font-medium">See the math engine in action. No manual calculations required.</p>
        </div>
            ...
            <div className="lg:col-span-1 space-y-12">
              ...
              <div className="space-y-6">
                <div className="p-8 bg-emerald-50 rounded-3xl border border-emerald-100">
                  <p className="text-xs text-emerald-600 mb-2 font-bold uppercase tracking-widest">Developer Sponsorship</p>
                  <p className="text-4xl font-extrabold text-emerald-700">150,000 <span className="text-sm font-normal opacity-50">AED</span></p>
                  <p className="text-[10px] text-emerald-500 font-bold mt-2 uppercase tracking-widest">Pure Margin Protection</p>
                </div>
                <div className="p-8 bg-slate-50 rounded-3xl border border-slate-200">
                  <p className="text-xs text-slate-500 mb-2 font-bold uppercase tracking-widest">Total Event Cost</p>
                ...
                <div className="p-8 bg-slate-950 rounded-3xl border border-slate-800 shadow-2xl">
                  <p className="text-xs text-slate-400 mb-2 font-bold uppercase tracking-widest">Branch Gross Profit</p>
                  <p className="text-4xl font-extrabold text-emerald-400">390,000 <span className="text-sm font-normal opacity-50 text-white">AED</span></p>
                </div>
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="p-8 bg-white border border-slate-200 rounded-3xl shadow-sm space-y-4">
                  <div className="flex justify-between items-center">
                    <span className="text-xs font-bold uppercase tracking-widest text-slate-400">Target Dilution</span>
                    <Cpu size={20} className="text-amber-500" />
                  </div>
                  <div className="text-5xl font-extrabold text-slate-900">75</div>
                  <p className="text-sm text-slate-500 font-bold uppercase tracking-widest">Leads per Agent</p>
                  <div className="pt-4 border-t border-slate-100 flex items-center gap-2 text-[10px] font-bold text-slate-400">
                    <Users size={12} /> 4 Approved Agents
                  </div>
                </div>
                <div className="p-8 bg-white border border-slate-200 rounded-3xl shadow-sm space-y-4">
                  <div className="flex justify-between items-center">
                    <span className="text-xs font-bold uppercase tracking-widest text-slate-400">Lead Conversion</span>
                    <TrendingUp size={20} className="text-emerald-500" />
                  </div>
                  <div className="text-5xl font-extrabold text-slate-900">104%</div>
                  <p className="text-sm text-slate-500 font-bold uppercase tracking-widest">Target Reached</p>
                  <div className="pt-4 border-t border-slate-100 flex items-center gap-2 text-[10px] font-bold text-emerald-500">
                    <CheckCircle2 size={12} /> 312 Total Leads
                  </div>
                </div>
              </div>
      ...
      <Section className="bg-white">
        <div className="text-center mb-20 space-y-4">
          ...
          <p className="text-xl text-slate-500 font-medium">Aligning agent incentives with branch profitability.</p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <motion.div whileHover={{ y: -10 }} className="p-8 bg-white border-2 border-amber-500 rounded-[2.5rem] shadow-2xl shadow-amber-500/10 relative overflow-hidden flex flex-col">
            ...
            <div className="mb-8">
              ...
              <p className="text-sm font-bold text-slate-500 uppercase tracking-widest">Commission Split</p>
            </div>
          ...
          <motion.div whileHover={{ y: -10 }} className="p-8 bg-slate-900 border border-slate-800 rounded-[2.5rem] shadow-2xl relative overflow-hidden flex flex-col">
            <div className="mb-8">
              ...
              <p className="text-sm font-bold text-slate-400 uppercase tracking-widest">Commission Split</p>
            </div>
            <div className="space-y-6 flex-1">
      ...
      <Section className="bg-slate-900 text-white border-y border-white/5">
        <div className="text-center mb-20 space-y-4">
          ...
          <p className="text-xl text-slate-400 font-medium">Dynamic dilution logic. Absolute mathematical fairness.</p>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12">
            ...
            <div className="flex-1 bg-white/5 border border-white/10 rounded-3xl p-8 text-center relative w-full">
              ...
              <div className="text-xs font-bold uppercase tracking-widest text-slate-400">Baseline Leads</div>
              <p className="mt-4 text-sm text-slate-500 font-medium">Branch commits to initial inventory targets.</p>
            </div>

            {/* Divider / Operator */}
            <div className="text-slate-600 font-extrabold text-4xl">÷</div>
            ...
            <div className="flex-1 bg-white/5 border border-white/10 rounded-3xl p-8 text-center relative w-full">
              ...
              <div className="text-xs font-bold uppercase tracking-widest text-slate-400">Approved Agents</div>
              <p className="mt-4 text-sm text-slate-500 font-medium">System verifies uploaded flights & visas.</p>
            </div>
            ...
            <div className="flex-1 bg-emerald-500/10 border border-emerald-500/30 rounded-3xl p-8 text-center relative w-full shadow-[0_0_30px_rgba(16,185,129,0.1)]">
              ...
              <p className="mt-4 text-sm text-emerald-200/60 font-medium relative z-10">Cloud Functions instantly recalculate.</p>
            </div>
      ...
      <Section className="bg-slate-50">
        <div className="text-center mb-20 space-y-4">
          ...
          <p className="text-xl text-slate-500 font-medium">Row-Level Security (RLS) via Firestore Rules.</p>
        </div>
        ...
        <div className="max-w-6xl mx-auto bg-white rounded-[3rem] border border-slate-200 shadow-2xl overflow-hidden flex flex-col lg:flex-row">
          ...
          <div className="flex-1 p-12 lg:p-16 border-b lg:border-b-0 lg:border-r border-slate-200 relative">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-100 text-slate-700 text-xs font-extrabold uppercase tracking-widest mb-8">
              <Lock size={14} /> Executive View
            </div>
            <h3 className="text-3xl font-extrabold text-slate-900 mb-8">Total Transparency</h3>
            
            <div className="space-y-6">
              <div className="p-6 bg-slate-50 rounded-2xl border border-slate-200">
                <p className="text-xs text-slate-500 font-bold uppercase tracking-widest mb-1">Total Event Cost</p>
          ...
          <div className="flex-1 p-12 lg:p-16 bg-slate-900 relative overflow-hidden">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 text-white text-xs font-extrabold uppercase tracking-widest mb-8 border border-white/20">
              <Users size={14} /> Agent View
            </div>
            ...
            <div className="space-y-6 relative">
              ...
              <div className="absolute inset-0 z-10 backdrop-blur-md bg-slate-900/50 flex items-center justify-center rounded-2xl border border-white/10">
                <div className="text-center">
                  ...
                  <p className="text-sm font-bold text-slate-400 uppercase tracking-widest">Company Margins Hidden</p>
                </div>
              </div>
              ...
              <div className="p-6 bg-white/5 rounded-2xl border border-white/10 opacity-50 blur-sm">
                <p className="text-xs text-slate-500 font-bold uppercase tracking-widest mb-1">Developer Sponsorship</p>
                <p className="text-2xl font-extrabold text-slate-700">XXX,XXX AED</p>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-wrap gap-6">
                {[
                  { icon: <Cpu />, label: "Serverless Functions" },
                  { icon: <Lock />, label: "RBAC Firestore Rules" },
                  { icon: <Globe />, label: "JWT Secured Webhooks" },
                  { icon: <Server />, label: "Real-time CRM Sync" }
                ].map((item, i) => (
                  <div key={i} className="flex items-center gap-3 text-white/60 font-bold text-sm uppercase tracking-widest">
          ...
          <div className="mt-24 pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] uppercase tracking-[0.2em] text-slate-500 font-bold">Executive Vision 2026</p>
              </div>
            </div>
