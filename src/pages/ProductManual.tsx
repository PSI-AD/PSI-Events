...
const TAB_COLOR = {
    amber: { active: 'bg-amber-500 text-white shadow-amber-500/30', inactive: 'text-psi-secondary hover:text-amber-300', dot: 'bg-amber-500', badge: 'text-amber-400 border-amber-500/30 bg-amber-500/10' },
    emerald: { active: 'bg-emerald-500 text-psi-primary shadow-emerald-500/30', inactive: 'text-psi-secondary hover:text-emerald-300', dot: 'bg-emerald-500', badge: 'text-emerald-400 border-emerald-500/30 bg-emerald-500/10' },
    blue: { active: 'bg-blue-500 text-psi-primary shadow-blue-500/30', inactive: 'text-psi-secondary hover:text-blue-300', dot: 'bg-blue-500', badge: 'text-blue-400 border-blue-500/30 bg-blue-500/10' },
};
        ...
        steps: [
            {
                ...
                screenshotIcon: <Calendar size={28} className="text-psi-secondary" />,
            ...
            },
            {
                ...
                screenshotIcon: <Award size={28} className="text-psi-secondary" />,
            ...
            },
            {
                ...
                screenshotIcon: <Users size={28} className="text-psi-secondary" />,
            ...
            },
            {
                ...
                screenshotIcon: <Upload size={28} className="text-psi-secondary" />,
            ...
            },
            {
                ...
                screenshotIcon: <BarChart3 size={28} className="text-psi-secondary" />,
        ...
        steps: [
            {
                ...
                screenshotIcon: <QrCode size={28} className="text-psi-secondary" />,
        ...
        steps: [
            {
                ...
                screenshotIcon: <FileText size={28} className="text-psi-secondary" />,
            ...
            },
            {
                ...
                screenshotIcon: <Sparkles size={28} className="text-psi-secondary" />,
...
function ScreenshotPlaceholder({
    ...
    return (
        <a
            ...
            className="group block w-full aspect-video bg-psi-surface border-2 border-dashed border-psi-strong hover:border-blue-500/60 hover:bg-psi-subtle rounded-2xl flex flex-col items-center justify-center gap-4 my-6 transition-all duration-200 hover:ring-2 hover:ring-blue-500/20 cursor-pointer px-6"
        >
            {/* Decorative chrome */}
            <div className="w-full max-w-xs flex flex-col gap-1.5 opacity-20 group-hover:opacity-35 transition-opacity pointer-events-none select-none">
                ...
                <div className="h-2.5 bg-psi-border rounded w-1/2" />
                <div className="h-14 bg-psi-border/60 rounded-xl mt-1" />
            </div>
            ...
            <div className="text-center space-y-2.5 w-full max-w-sm">
                ...
                <div className="flex items-center justify-center gap-1.5 text-xs font-mono">
                    ...
                    <button
                        ...
                        className="relative inline-flex items-center gap-1 bg-psi-border/60 hover:bg-slate-600/80 border border-slate-600/60 hover:border-emerald-500/50 text-emerald-400 font-bold px-2 py-0.5 rounded-lg transition-all duration-150 cursor-pointer"
                    >
                        {filename}
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-psi-secondary">
        ...
        <section id={step.id} className="scroll-mt-32 md:scroll-mt-24 pb-12 md:pb-16">
            ...
            <div className="flex items-start gap-4 mb-4">
                ...
                <div className="min-w-0">
                    ...
                    <h2 className="text-psi-primary text-xl md:text-2xl font-extrabold tracking-tight leading-tight">
                        {step.title}
                    </h2>
                    <p className="text-psi-secondary text-sm md:text-base mt-1.5 leading-relaxed">{step.subtitle}</p>
                    ...
                    {(() => {
                        ...
                        return (
                            <a
                                ...
                                className="mt-2 inline-flex items-center gap-1.5 bg-psi-subtle/70 border border-psi-strong/60 hover:border-blue-500/40 rounded-lg px-2.5 py-1 group transition-all duration-150"
                            >
                                <span className="text-[9px] font-black uppercase tracking-widest text-psi-secondary">📸 screen</span>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <span className={cn(
                                        ...
                                        isActive ? 'bg-psi-border' : 'bg-psi-subtle text-psi-muted'
                                    )}>
                                        {p.steps.length}
                                    </span>
                                </button>
                        ...
                        >
                            ...
                            <div className={cn(
                                ...
                                <div>
                                    ...
                                    <p className="text-psi-secondary text-sm">{phase.tagline} · {phase.steps.length} steps</p>
                                </div>
                            </div>
                                    ...
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            phase.color === 'amber'
                                                ...
                                                : 'bg-emerald-500 hover:bg-emerald-400 text-psi-primary'
                                        )}
                                    >
                                        Next Phase
                                        <ArrowRight size={15} />
...
export default function ProductManual() {
    ...
    return (
        <div className="min-h-screen bg-psi-page font-sans flex flex-col">
            {/* ── Top tab switcher ── */}
            <div className="bg-psi-surface border-b border-psi px-4 py-2 flex items-center gap-1 flex-shrink-0 z-20">
                {([
                    { id: 'visual' as ManualTab, label: '📘 Visual System Manual', active: 'bg-emerald-500 text-psi-primary shadow-emerald-500/20', inactive: 'text-psi-secondary hover:text-emerald-600 dark:hover:text-emerald-400' },
                    { id: 'lifecycle' as ManualTab, label: '📋 Lifecycle Guide', active: 'bg-blue-500 text-psi-primary shadow-blue-500/20', inactive: 'text-psi-secondary hover:text-blue-600 dark:hover:text-blue-400' },
