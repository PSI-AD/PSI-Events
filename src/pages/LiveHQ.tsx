 ...
 *
 * Design system:
 *   bg-slate-950 (TV-safe near-black)
    ...
    return (
        <div className="flex items-center gap-6">
            ...
            <div className="text-right">
                <p className="text-slate-500 text-xs font-bold uppercase tracking-widest mb-0.5">
                    {EVENT_META.city} · MSK
                </p>
            ...
            <div className="text-right">
                ...
                <p className="font-mono font-black text-slate-300 text-3xl tracking-wider leading-none">
                    {hq.time}
                </p>
                <p className="text-slate-500 text-xs mt-0.5">{hq.date}</p>
            </div>
        </div>
    );
}
    ...
    return (
        <div className="flex items-center gap-3">
            ...
            <div>
                ...
                <p className="text-white font-black text-2xl md:text-3xl leading-tight truncate max-w-xs">
                    {EVENT_META.shortName}
                </p>
                <div className="flex items-center gap-2 mt-0.5">
                    <MapPin size={10} className="text-slate-500" />
                    <p className="text-slate-400 text-xs">{EVENT_META.venueAddress}</p>
                </div>
            </div>
        </div>
    );
                    ...
                    {events.map((ev) => (
                        ...
                        >
                            ...
                            <div className="min-w-0">
                                <p className="text-slate-500 text-[10px] font-mono mb-0.5">{ev.time}</p>
                            ...
                            >
                                ...
                                {i >= items.length - 2 && (
                                    <div className="absolute top-1.5 left-1.5">
                                        <span className="px-1.5 py-0.5 bg-emerald-500 rounded-md text-[9px] font-black text-white uppercase tracking-wider">
                                            NEW
                                        </span>
                                    </div>
                                )}
...
const RANK_STYLES = {
    ...
    silver: { border: 'border-slate-400/30', bg: 'bg-slate-400/5', text: 'text-slate-300', medal: '🥈' },
    ...
    return (
        ...
        >
            ...
            <div className="flex-1 min-w-0">
                ...
                <p className="text-slate-500 text-xs truncate">{agent.branch}</p>
            </div>

            {/* Leads */}
            <div className="text-right flex-shrink-0">
                <p className="font-black text-2xl text-white">{agent.leadsToday}</p>
                <p className="text-slate-500 text-[10px] font-bold uppercase">leads</p>
            </div>
            ...
            {agent.dealValue > 0 && (
                <div className="flex-shrink-0 text-right">
                    ...
                    <p className="text-slate-500 text-[10px]">AED</p>
                </div>
            )}
                    ...
                    >
                        ...
                        <div className="relative z-10 text-center px-8 max-w-5xl mx-auto">
                            ...
                            <motion.div
                                ...
                                className="space-y-1"
                            >
                                <p className="text-white/80 text-2xl font-bold">{deal.projectName}</p>
                            ...
                            <motion.button
                                ...
                                onClick={onDismiss}
                                className="mt-12 px-6 py-3 bg-white/10 border border-white/20 rounded-2xl text-white/60 text-sm font-bold hover:bg-white/15 transition-colors"
                            >
...
export default function LiveHQ() {
    ...
    return (
        <div className="fixed inset-0 bg-slate-950 text-white flex flex-col overflow-hidden select-none">
            ...
            {/* ── HEADER ──────────────────────────────────────────────────── */}
            <header className="flex-shrink-0 flex items-center justify-between px-6 py-4 border-b border-white/5 bg-slate-950/80 backdrop-blur-sm">
                <LiveIndicator />
            ...
            <div className="flex-1 flex overflow-hidden min-h-0">
                ...
                <div className="w-[30%] flex-shrink-0 border-r border-white/5 p-5 overflow-hidden flex flex-col">
                    <TelemetryFeed events={telemetry} />
                </div>

                {/* ── PANE 2: Media Wall (40%) ─────────────────────────── */}
                <div className="flex-1 border-r border-white/5 p-5 overflow-hidden flex flex-col">
            ...
            {/* ── FOOTER TICKER ───────────────────────────────────────────── */}
            <footer className="flex-shrink-0 border-t border-white/5 bg-slate-900/50 px-0 py-0 overflow-hidden">
                            ...
                            {[...Array(2)].map((_, rep) => (
                                <span key={rep} className="flex gap-12">
                                    {[
                                        ...
                                        <span key={i} className="text-slate-400 text-xs font-bold">
                                            {msg}
                ...
                {showControls && (
                    ...
                    >
                        ...
                        <button
                            ...
                            onClick={triggerDeal}
                            className="flex items-center gap-2 px-4 py-3 bg-emerald-600 hover:bg-emerald-500 border border-emerald-500/30 rounded-2xl text-white text-sm font-black shadow-2xl shadow-emerald-500/20 transition-all active:scale-95"
                        >
                            <Zap size={16} />
                            Simulate Deal Close
                        </button>
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-3 bg-blue-600 hover:bg-blue-500 border border-blue-500/30 rounded-2xl text-white text-sm font-black shadow-xl shadow-blue-500/20 transition-all active:scale-95"
                        >
                            <Camera size={16} />
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-3 bg-slate-800 hover:bg-slate-700 border border-slate-700 rounded-2xl text-slate-400 text-sm font-bold transition-all active:scale-95"
                        >
                            <X size={14} />
                            Hide Controls
                        </button>
            ...
            <AnimatePresence>
                {!showControls && (
                    <motion.button
                        ...
                        className="fixed bottom-16 right-5 z-40 w-10 h-10 bg-slate-800 border border-slate-700 rounded-xl flex items-center justify-center text-slate-500 hover:text-white transition-colors"
                    >
                        <Play size={14} />
                    </motion.button>
                )}
