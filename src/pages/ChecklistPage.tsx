...
export default function ChecklistPage() {
    ...
    return (
        <div className="min-h-screen bg-psi-page">
            {/* ── Hero header ── */}
            <div className="bg-psi-surface border-b border-psi">
                <div className="max-w-4xl mx-auto px-6 md:px-10 py-8 md:py-10">
                    ...
                    <div className="flex items-center gap-2 text-[11px] font-bold text-psi-muted uppercase tracking-widest mb-4">
                        ...
                        <span className="text-psi-accent">Checklist</span>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <h1 className="text-2xl md:text-3xl font-extrabold text-psi-primary tracking-tight leading-tight">
                                Logistics &amp; Compliance Action Center
                            </h1>
                            <p className="text-psi-secondary mt-1.5 text-sm leading-relaxed">
                    ...
                    <div className="flex flex-wrap gap-3 mt-6">
                        ...
                        <motion.div
                            ...
                            className="flex items-center gap-2.5 bg-psi-subtle border border-psi rounded-xl px-4 py-2.5"
                        >
                        ...
                        <motion.div
                            ...
                            className="flex items-center gap-2 bg-blue-50 border border-blue-200 rounded-xl px-4 py-2.5"
                        >
                    ...
                    <div className="mt-5 w-full h-2 bg-psi-border-subtle rounded-full overflow-hidden">
                        <motion.div
                            initial={{ width: 0 }}
