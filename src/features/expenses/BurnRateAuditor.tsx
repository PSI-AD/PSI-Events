                        ...
                        <div className="border-t border-psi px-5 py-4 space-y-5">
                            ...
                            <div className={`rounded-2xl border p-4 ${isFrozen ? 'bg-rose-50 dark:bg-rose-950/20 border-rose-300 dark:border-rose-700/50' : 'bg-psi-subtle border-psi'}`}>
                                <div className="flex items-center justify-between gap-4 flex-wrap">
                                    <div className="flex items-center gap-3">
                                        <div className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 ${isFrozen ? 'bg-rose-500 text-white' : 'bg-psi-card text-psi-muted'}`}>
                                    ...
                                    {canToggleFreeze ? (
                                        <motion.button
                                            ...
                                            className={`flex items-center gap-2 px-5 py-2.5 rounded-xl font-bold text-sm transition-all select-none ${isFrozen ? 'bg-emerald-500 hover:bg-emerald-400 text-white shadow shadow-emerald-500/20' : 'bg-rose-500 hover:bg-rose-400 text-white shadow shadow-rose-500/20'}`}
                                        >
                            ...
                            {isCritical && !isFrozen && (
                                <motion.div
                                    initial={{ opacity: 0 }}
                                    animate={{ opacity: 1 }}
                                    className="flex items-start gap-3 p-4 bg-rose-500 rounded-2xl text-white"
                                >
