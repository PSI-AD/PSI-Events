        ...
        <button
            ...
            className={cn(
                ...
                isVoted
                    ...
                    : disabled
                        ? 'border-psi-strong bg-psi-subtle cursor-default'
                        : 'border-psi-strong bg-psi-subtle/60 hover:border-psi-strong hover:bg-psi-subtle cursor-pointer'
            )}
        >
            {/* Fill bar */}
            <motion.div
                ...
                className={cn(
                    ...
                    isVoted ? 'bg-emerald-600/25' : 'bg-psi-border/40'
                )}
            />
            {/* Content */}
            <div className="relative flex items-center justify-between px-4 py-3">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-psi-primary text-sm font-medium">{option.text}</span>
                </div>
                <div className="flex items-center gap-2 flex-shrink-0 ml-2">
                    <span className="text-emerald-400 font-black text-sm">{pct}%</span>
                    <span className="text-psi-secondary text-xs">({option.votes})</span>
                </div>
            </div>
        </button>
    );
...
function QuestionCard({
    ...
    return (
            ...
            className={cn(
                ...
                isHighlighted
                    ...
                    : question.status === 'pending'
                        ? 'bg-psi-subtle/40 border-psi-strong/60'
        ...
        >
            ...
            <p className="text-psi-primary text-sm leading-relaxed mb-2">{question.text}</p>
            <div className="flex items-center justify-between gap-2">
                <div className="flex items-center gap-3">
                    <span className="text-psi-secondary text-[11px]">{question.author}</span>
                    <span className="text-psi-muted text-[10px]">{relTime(question.timestamp)}</span>
                </div>
                <div className="flex items-center gap-1.5">
                        ...
                        <button
                            ...
                            className={cn(
                                ...
                                hasUpvoted
                                    ...
                                    : 'bg-psi-border text-psi-secondary border border-psi-strong hover:bg-psi-subtle hover:text-psi-primary'
                            )}
                        >
                    ...
                    {isHost && onModerate && (
                        <>
                            <span className="text-psi-secondary text-xs flex items-center gap-1 mr-1">
                            ...
                            {question.status === 'highlighted' && (
                                <button
                                    ...
                                    className="p-1.5 rounded-lg bg-psi-border text-psi-secondary hover:text-psi-primary transition-colors"
                                >
                                    <Star size={12} />
                                </button>
                            )}
...
function AttendeeView({
    ...
    return (
        <div className="flex-1 flex flex-col overflow-hidden">
            {/* Tab bar */}
            <div className="flex border-b border-psi px-4 bg-psi-surface/60">
                {([
            ...
            <div className="flex-1 overflow-y-auto p-5 space-y-4">
                    ...
                    <>
                        {livePoll ? (
                            <div>
                                ...
                                <h3 className="text-psi-primary font-bold text-base mb-4 leading-snug">{livePoll.question}</h3>
                                ...
                                <div className="flex items-center justify-between mt-3">
                                    <p className="text-psi-secondary text-xs">{livePoll.totalVotes} votes · Live updating</p>
                                    {hasVoted && <p className="text-emerald-400 text-xs font-semibold">✓ Your vote recorded</p>}
                                </div>
                            </div>
                        ) : (
                            <div className="text-center py-16">
                                <BarChart2 size={40} className="text-psi-muted mx-auto mb-3" />
                                <p className="text-psi-primary font-bold mb-1">No active poll</p>
                                <p className="text-psi-secondary text-sm">The host will launch a poll soon</p>
                            </div>
                        )}
                    </>
                )}
                    ...
                    <>
                        ...
                        {highlightedQuestion && (
                            <div className="bg-amber-900/20 border border-amber-600/40 rounded-2xl p-4 mb-2">
                                ...
                                <p className="text-psi-primary font-semibold text-sm leading-snug">{highlightedQuestion.text}</p>
                            </div>
                        )}

                        {/* Submit question */}
                        <div className="bg-psi-surface border border-psi rounded-2xl p-4">
                            <p className="text-psi-primary font-semibold text-sm mb-3">Submit a Question</p>
                            {submitted ? (
                                ...
                                <>
                                    <textarea
                                        ...
                                        rows={3}
                                        maxLength={280}
                                        className="w-full bg-psi-subtle border border-psi-strong rounded-xl px-3 py-2.5 text-sm text-psi-primary placeholder-slate-500 focus:outline-none focus:border-emerald-500 resize-none transition-colors mb-2"
                                    />
                                    <div className="flex items-center gap-2">
                                        <input
                                            value={qAuthor}
                                            ...
                                            className="flex-1 bg-psi-subtle border border-psi-strong rounded-xl px-3 py-2 text-sm text-psi-primary placeholder-slate-500 focus:outline-none focus:border-emerald-500 transition-colors"
                                        />
                                        <button
                                            onClick={handleSubmitQ}
                                            disabled={!qText.trim() || !qAuthor.trim()}
                                            className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-emerald-600 text-white text-sm font-bold hover:bg-emerald-500 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
                                        >
                                            <Send size={13} /> Submit
                                        </button>
                                    </div>
                                    <p className="text-psi-muted text-[10px] mt-1.5">{qText.length}/280</p>
                                </>
                            )}
                        </div>
                        ...
                        <div>
                            <p className="text-psi-secondary text-[10px] font-black uppercase tracking-wider mb-2">{approvedQuestions.length} Approved Questions</p>
                            <AnimatePresence>
                            ...
                            {approvedQuestions.length === 0 && (
                                <p className="text-psi-muted text-sm text-center py-6">No approved questions yet</p>
                            )}
                        </div>
                    </>
                )}
                ...
                {tab === 'reactions' && (
                    <div>
                        <p className="text-psi-primary font-bold text-sm mb-4">Tap to send a reaction</p>
                        <div className="grid grid-cols-4 gap-3 mb-6">
                            {EMOJI_OPTIONS.map(emoji => (
                                <button
                                    key={emoji}
                                    onClick={() => { sendReaction(emoji); toast.success('Reaction sent!', { duration: 1000 }); }}
                                    className="flex flex-col items-center gap-1.5 py-4 rounded-2xl bg-psi-subtle border border-psi-strong hover:bg-psi-subtle hover:scale-105 active:scale-95 transition-all"
                                >
                                    <span className="text-3xl">{emoji}</span>
                                    <span className="text-psi-secondary text-[10px] font-bold">{(reactionCounts[emoji] ?? 0).toLocaleString()}</span>
                                </button>
                            ))}
                        </div>
                        <p className="text-psi-secondary text-xs text-center">Reactions are visible to everyone in the room</p>
                    </div>
                )}
            </div>
        </div>
...
function HostView(props: ReturnType<typeof useEngagement>) {
    ...
    return (
        <div className="flex-1 flex overflow-hidden">
            ...
            {/* ── Left: Controls ──────────────────────────────────────── */}
            <div className="w-96 border-r border-psi flex flex-col overflow-hidden flex-shrink-0">
                {/* Tab bar */}
                <div className="flex border-b border-psi px-2 pt-1 bg-psi-surface/60">
                    {([
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-3">
                    ...
                    {tab === 'polls' && (
                        <>
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl bg-emerald-600 text-white text-sm font-bold hover:bg-emerald-500 transition-colors"
                            >
                            ...
                            <AnimatePresence>
                                {showNewPoll && (
                                    <motion.div
                                        ...
                                        className="bg-psi-subtle border border-psi-strong rounded-2xl p-4 space-y-2 overflow-hidden"
                                    >
                                        <p className="text-psi-primary font-bold text-xs mb-2">Create Poll</p>
                                        <input value={newQ} onChange={e => setNewQ(e.target.value)} placeholder="Poll question…"
                                            className="w-full bg-psi-surface border border-psi-strong rounded-xl px-3 py-2 text-xs text-psi-primary placeholder-slate-500 focus:outline-none focus:border-emerald-500" />
                                        {newOpts.map((opt, i) => (
                                        ...
                                        <div className="flex gap-2 pt-1">
                                            <button onClick={handleCreatePoll} className="flex-1 py-2 rounded-xl bg-emerald-600 text-white text-xs font-bold hover:bg-emerald-500 transition-colors">Create</button>
                                            <button onClick={() => setShowNewPoll(false)} className="px-4 py-2 rounded-xl bg-psi-border text-psi-secondary text-xs hover:bg-psi-subtle transition-colors">Cancel</button>
                                        </div>
                                    </motion.div>
                                )}
                            </AnimatePresence>
                            ...
                            {polls.map(poll => (
                                <div key={poll.id} className={cn(
                                    'bg-psi-surface border rounded-xl p-4',
                                    poll.isLive ? 'border-emerald-600/50' : 'border-psi'
                                )}>
                                    <div className="flex items-start gap-2 mb-2">
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <p className="text-psi-primary text-xs font-semibold leading-snug line-clamp-2">{poll.question}</p>
                                        </div>
                                    </div>
                                                ...
                                                return (
                                                    <div key={opt.id}>
                                                        <div className="flex justify-between text-[10px] mb-0.5">
                                                            <span className="text-psi-secondary truncate">{opt.text}</span>
                                                            <span className="text-emerald-400 font-bold ml-2">{pct}%</span>
                                                        </div>
                                                        <div className="w-full bg-psi-subtle rounded h-1.5">
                    ...
                    {tab === 'qa' && (
                        <>
                            ...
                            <div>
                                <p className="text-psi-secondary text-[10px] font-black uppercase tracking-wider mb-2">Approved ({approvedQuestions.length})</p>
                                <AnimatePresence>
                                    {approvedQuestions.map(q => (
                                        <div key={q.id} className="mb-2">
                                            <QuestionCard question={q} isHost onModerate={moderateQuestion} />
                    ...
                    {tab === 'stats' && (
                        <div className="space-y-4">
                            ...
                            <div className="bg-psi-subtle border border-psi-strong rounded-2xl p-4 flex items-center gap-4">
                                <div className="relative w-16 h-16 flex-shrink-0">
                                    <svg className="w-16 h-16 -rotate-90" viewBox="0 0 56 56">
                                        <circle cx="28" cy="28" r="22" fill="none" strokeWidth="5" className="stroke-psi-border" />
                                    ...
                                    <div className="absolute inset-0 flex items-center justify-center">
                                        <span className="text-psi-primary font-black text-sm">{selectedSession.engagementScore}%</span>
                                    </div>
                                </div>
                                <div>
                                    <p className="text-psi-primary font-bold">Engagement Score</p>
                                    <p className="text-psi-secondary text-xs mt-0.5"><Users size={10} className="inline mr-1" />{selectedSession.attendeeCount} in session</p>
                                </div>
                            </div>

                            {/* Reaction breakdown */}
                            <div className="bg-psi-subtle border border-psi-strong rounded-2xl p-4">
                                <p className="text-psi-primary font-bold text-xs mb-3">Reaction Totals</p>
                                {EMOJI_OPTIONS.map(emoji => {
                                    ...
                                    return (
                                        <div key={emoji} className="flex items-center gap-2 mb-2">
                                            ...
                                            <div className="flex-1 bg-psi-border rounded-full h-1.5">
                                                <motion.div
                                                    animate={{ width: `${max === 0 ? 0 : (count / max) * 100}%` }}
                                                    className="h-1.5 rounded-full bg-emerald-500"
                                                />
                                            </div>
                                            <span className="text-psi-secondary text-xs font-bold w-8 text-right">{count}</span>
                                        </div>
                                    );
                                })}
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                {[
                                    ...
                                    <div key={s.label} className="bg-psi-subtle border border-psi-strong rounded-xl p-3 text-center">
                                        <p className="text-psi-primary font-black text-xl">{s.value}</p>
                                        <p className="text-psi-secondary text-[10px] uppercase tracking-wide">{s.label}</p>
                                    </div>
                                ))}
                            </div>
                        </div>
            ...
            {/* ── Right: Live Preview ──────────────────────────────────── */}
            <div className="flex-1 flex flex-col bg-psi-page relative overflow-hidden">
                <div className="flex items-center justify-between px-5 py-3 border-b border-psi bg-psi-surface/60 flex-shrink-0">
                    <p className="text-psi-secondary text-xs font-bold uppercase tracking-wider flex items-center gap-2">
                        <Eye size={12} /> Audience View Preview
                    </p>
                    <span className="text-psi-muted text-xs">What attendees see on screen</span>
                </div>
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-6">
                    ...
                    {props.highlightedQuestion && (
                        <div className="bg-amber-900/25 border-2 border-amber-600/50 rounded-2xl p-6 text-center">
                            ...
                            <p className="text-psi-primary font-bold text-lg leading-snug">{props.highlightedQuestion.text}</p>
                            <p className="text-psi-secondary text-sm mt-2">— {props.highlightedQuestion.author}</p>
                        </div>
                    )}

                    {/* Live poll preview */}
                    {livePoll && (
                        <div className="bg-psi-surface border border-emerald-800/40 rounded-2xl p-6">
                            <div className="flex items-center gap-2 mb-3">
                                <PulseDot />
                                <span className="text-emerald-400 font-black text-xs uppercase">Live Poll · {livePoll.totalVotes} votes</span>
                            </div>
                            <h3 className="text-psi-primary font-bold text-base mb-4">{livePoll.question}</h3>
                                    ...
                                    return (
                                        <div key={opt.id}>
                                            <div className="flex justify-between mb-1">
                                                <span className={cn('text-sm', isWinning ? 'text-psi-primary font-bold' : 'text-psi-secondary')}>{opt.text}</span>
                                                <span className={cn('font-black text-sm', isWinning ? 'text-emerald-400' : 'text-psi-secondary')}>{pct}%</span>
                                            </div>
                                            <div className="w-full bg-psi-subtle rounded-full h-3">
                                                <motion.div
                                                    animate={{ width: `${pct}%` }}
                                                    transition={{ duration: 0.4 }}
                                                    className={cn('h-3 rounded-full', isWinning ? 'bg-emerald-500' : 'bg-psi-border')}
                                                />
                                            </div>
                                        </div>
                                    );
                    ...
                    <div>
                        <p className="text-psi-secondary text-xs font-black uppercase tracking-wider mb-3">Top Questions</p>
                        {approvedQuestions.slice(0, 3).map((q, i) => (
                            <div key={q.id} className={cn(
                                'mb-2 bg-psi-surface border rounded-xl p-3',
                                i === 0 ? 'border-violet-600/40' : 'border-psi'
                            )}>
                                <div className="flex items-start gap-2">
                                    <span className="text-psi-muted font-black text-sm w-5 flex-shrink-0">{i + 1}.</span>
                                    <p className="text-psi-primary text-sm flex-1">{q.text}</p>
                                    <span className="text-psi-secondary text-xs flex items-center gap-0.5 flex-shrink-0">
                    ...
                    <div className="bg-psi-surface border border-psi rounded-2xl p-4">
                        <p className="text-psi-secondary text-xs font-black uppercase tracking-wider mb-3">Live Reactions</p>
                ...
                <div className="flex items-center justify-between gap-4 flex-wrap">
                    <div>
                        <div className="flex items-center gap-2">
                            ...
                            <h1 className="text-psi-primary font-extrabold text-base">Live Engagement</h1>
                            <PulseDot />
                        </div>
                    ...
                    <div className="flex items-center gap-3 flex-wrap">
                        ...
                        <select
                            ...
                            className="bg-psi-subtle border border-psi-strong text-psi-secondary text-xs rounded-xl px-3 py-2 focus:outline-none focus:border-emerald-500 transition-colors"
                        >
                            {SESSIONS.map(s => (
                        ...
                        {/* Mode toggle */}
                        <div className="flex bg-psi-subtle border border-psi-strong rounded-xl p-0.5 gap-0.5">
                            <button
                                onClick={() => setMode('attendee')}
                                className={cn(
                                    'flex items-center gap-1.5 px-3.5 py-2 rounded-lg text-xs font-bold transition-all',
                                    mode === 'attendee' ? 'bg-emerald-600 text-white shadow' : 'text-psi-secondary hover:text-psi-primary'
                                )}
                            >
                            ...
                            <button
                                ...
                                className={cn(
                                    'flex items-center gap-1.5 px-3.5 py-2 rounded-lg text-xs font-bold transition-all',
                                    mode === 'host' ? 'bg-violet-600 text-psi-primary shadow' : 'text-psi-secondary hover:text-psi-primary'
                                )}
                            >
                                <Mic size={12} /> Host
                            </button>
