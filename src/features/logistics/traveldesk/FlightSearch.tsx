...
export function FlightCard({
    ...
    return (
        ...
        >
            {overBudget && (
                <div className="flex items-center gap-1.5 px-4 py-1.5 bg-rose-500 text-psi-primary text-[10px] font-black uppercase tracking-widest">
            ...
            <div className="p-4 sm:p-5">
                <div className="flex flex-col sm:flex-row gap-4">
                    <div className="flex items-start gap-3 flex-1 min-w-0">
                        <div className="w-11 h-11 rounded-xl bg-psi-subtle flex items-center justify-center text-xl flex-shrink-0 border border-psi-strong">
                            {flight.logo}
                        </div>
                        ...
                        <motion.button
                            ...
                            className={clsx(
                                ...
                                overBudget
                                    ...
                                    : booking
                                        ? 'bg-amber-500/50 text-psi-primary cursor-wait'
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-4">
                ...
                <div className="psi-card rounded-2xl p-4 border border-psi">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-xl bg-psi-subtle border border-psi-strong flex items-center justify-center text-lg">
                            {booked.logo}
                        </div>
        ...
        <div className="space-y-4">
            ...
            {phase === 'idle' && (
                <motion.button
                    ...
                    className="w-full flex items-center justify-center gap-2.5 py-5 rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-psi-primary font-extrabold text-sm shadow-lg shadow-blue-500/20 transition-all"
                >
