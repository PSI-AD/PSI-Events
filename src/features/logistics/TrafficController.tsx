...
const ZONES: FloorZone[] = [
    ...
    },
    {
        ...
        capacity: 999,
        color: 'bg-white/3', border: 'border-white/10', accent: 'bg-slate-600', textAccent: 'text-white/40',
        icon: <Users size={14} />,
        gridArea: 'unassigned',
    ...
    return (
        <motion.div
            ...
            className={`
                ...
                ${isDragging
                    ? 'opacity-40 border-white/30 bg-white/10'
        ...
        >
            ...
            {!compact && (
                <div className="min-w-0">
                    <p className="text-white text-[11px] font-bold truncate max-w-[90px]">
                        {agent.agentName.split(' ')[0]}
                    </p>
                    <p className="text-white/30 text-[8px] truncate">{agent.branch}</p>
                </div>
            )}
        </motion.div>
    );
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-1.5">
                    <span className={`text-[10px] font-black ${isFull ? 'text-rose-400' : 'text-white/30'}`}>
            ...
            {isDragOver && (
                <motion.div
                    ...
                    className="absolute inset-0 rounded-2xl border-2 border-dashed border-white/40 bg-white/5 flex items-center justify-center pointer-events-none"
                >
                    <span className="text-white/50 text-xs font-bold">Drop here</span>
                </motion.div>
            )}
        </div>
    );
...
function AlertLogEntry({ alert }: { alert: TrafficAlert }) {
    ...
    return (
        ...
        >
            ...
            <p className="text-white/70 text-xs font-bold truncate">{alert.agentName}</p>
            <p className="text-white/30 text-[10px] mt-0.5 leading-relaxed line-clamp-2">{alert.message}</p>
        </motion.div>
    );
}
    ...
    return (
        <AnimatePresence>
            ...
            >
                ...
                <h2 className="text-white text-2xl font-extrabold mb-2">Zone Reassignment</h2>
                ...
                <div className="bg-white/6 border border-white/10 rounded-2xl p-5 max-w-sm w-full text-left mb-6">
                ...
                <p className="text-white/20 text-xs mt-4">Please make your way to the {toZone.shortLabel} immediately.</p>
            </motion.div>
        </AnimatePresence>
    );
}
        ...
        <div className="min-h-screen bg-slate-950 text-white flex flex-col">
            ...
            <header className="border-b border-white/8 px-5 py-4 flex items-center justify-between gap-4 flex-wrap">
                <div>
                    ...
                    <h1 className="text-white text-xl font-extrabold">Traffic Controller</h1>
                    <p className="text-white/30 text-xs mt-0.5">{eventName}</p>
                </div>
            ...
            <AnimatePresence>
                {lastAction && (
                    <motion.div
                        ...
                        exit={{ opacity: 0, y: -20 }}
                        className="fixed top-20 left-1/2 -translate-x-1/2 z-50 flex items-center gap-2.5 bg-indigo-600 text-white text-xs font-extrabold px-4 py-2.5 rounded-2xl shadow-2xl shadow-indigo-600/30"
                    >
            ...
            <div className="flex flex-1 overflow-hidden gap-0">
                ...
                <div className="flex-1 overflow-y-auto p-4 md:p-6">
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        <p className="text-white/30 text-xs font-bold uppercase tracking-widest">Event Floor Plan</p>
                        <span className="text-white/15 text-[10px]">— drag agent badges between zones to redeploy</span>
                    </div>
                    ...
                    <div className="mt-4">
                        <div className="flex items-center gap-2 mb-2">
                            <span className="text-white/20 text-[10px] font-bold uppercase tracking-widest">Holding Area</span>
                            <span className="text-white/15 text-[9px]">← agents here are not yet deployed</span>
                        </div>
                        <ZoneTile
                            zone={unassignedZone}
                    ...
                    <div className="mt-4 flex flex-wrap gap-3">
                        ...
                        <div className="flex items-center gap-1.5 text-[10px] text-white/20 ml-auto">
                ...
                <div className="hidden lg:flex w-72 flex-col border-l border-white/8 overflow-hidden">
                    <div className="px-4 py-4 border-b border-white/8">
                        <div className="flex items-center gap-2">
                            ...
                            <p className="text-white font-extrabold text-sm">Alert Log</p>
                        </div>
                        <p className="text-white/25 text-[10px] mt-0.5">{alerts.length} notifications sent</p>
                    </div>
