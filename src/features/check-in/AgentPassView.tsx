    ...
    return (
        <div className="min-h-screen bg-psi-page flex flex-col items-center justify-center p-4">
            ...
            <div className="w-full max-w-sm flex items-center justify-between mb-4 px-1">
                <span className="text-xs text-psi-secondary font-mono">{formatTime(new Date())}</span>
            ...
            >
                ...
                {isPresent ? (
                    <div className="bg-gradient-to-b from-emerald-950 to-white dark:to-slate-900 rounded-3xl overflow-hidden shadow-2xl border border-emerald-800/50">
                        ...
                        <div className="bg-emerald-900/60 border-b border-emerald-700/40 px-6 pt-6 pb-5">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h1 className="text-psi-primary text-xl font-extrabold tracking-tight">Attendance Confirmed</h1>
                        ...
                        <div className="px-6 py-6 space-y-4">
                            <div className="bg-emerald-900/30 border border-emerald-800/50 rounded-2xl p-4">
                                ...
                                <p className="text-psi-primary font-bold text-lg">{agent.agentName}</p>
                            ...
                            <p className="text-center text-psi-secondary text-sm">
                    ...
                    /* Main pass card */
                    <div className="bg-psi-surface rounded-3xl overflow-hidden shadow-2xl shadow-black/50 border border-psi">

                        {/* Header stripe */}
                        <div className="bg-gradient-to-r from-white dark:from-slate-900 via-slate-800 to-white dark:to-slate-900 px-6 pt-6 pb-5 border-b border-psi-strong/50">
                            <div className="flex items-start justify-between">
                                <div>
                                    <p className="text-amber-400 text-[10px] font-bold tracking-[0.25em] uppercase mb-1.5">
                                        PSI Event Portal
                                    </p>
                                    <h1 className="text-psi-primary text-xl font-extrabold tracking-tight leading-tight">
                                        Event Access Pass
                                    </h1>
                                </div>
                                {/* Tier badge */}
                        ...
                        <div className="flex flex-col items-center px-6 pt-6 pb-4">
                            {jwt ? (
                                ...
                                <div className="w-[216px] h-[216px] bg-psi-subtle rounded-2xl flex items-center justify-center">
                            ...
                            <div className="mt-4 flex items-center gap-2">
                                <Clock size={12} className="text-psi-secondary" />
                                <span className="text-xs text-psi-secondary">
                                    QR refreshes in{' '}
                        ...
                        <div className="relative mx-4">
                            <div className="border-t border-dashed border-psi-strong" />
                            <div className="absolute -left-8 top-1/2 -translate-y-1/2 w-6 h-6 bg-psi-page rounded-full border border-psi" />
                            <div className="absolute -right-8 top-1/2 -translate-y-1/2 w-6 h-6 bg-psi-page rounded-full border border-psi" />
                        </div>
                        ...
                        <div className="px-6 pt-4 pb-6 space-y-3">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-psi-primary font-bold text-base leading-tight">{agent.agentName}</p>
                                    <p className="text-psi-secondary text-xs">{agent.branch}</p>
                                </div>
                            </div>

                            <div className="bg-psi-subtle/60 rounded-xl px-4 py-3 space-y-2">
                                <div className="flex items-start gap-2">
                                    <MapPin size={13} className="text-amber-400 mt-0.5 flex-shrink-0" />
                                    <div>
                                        <p className="text-psi-primary text-sm font-semibold leading-tight">{event.eventName}</p>
                                        <p className="text-psi-secondary text-xs">{event.venue}</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-2">
                                    <Clock size={13} className="text-amber-400 flex-shrink-0" />
                                    <p className="text-psi-secondary text-xs">{formatDate(event.eventDate)}</p>
                                </div>
                            </div>
                        ...
                        {/* Footer bar */}
                        <div className="bg-psi-subtle/80 px-6 py-3 flex items-center justify-between border-t border-psi-strong/50">
                            <div className="flex items-center gap-1.5">
