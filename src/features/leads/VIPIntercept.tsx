...
function TierBadge({ tier, agentTier = false }: { tier: string; agentTier?: boolean }) {
    ...
    const map: Record<string, string> = {
        ...
        Medium: 'bg-blue-600 text-psi-primary',
    ...
    return (
        <div className="relative flex items-center justify-center">
            ...
            <div className="w-14 h-14 rounded-full bg-rose-500 flex items-center justify-center shadow-xl shadow-rose-500/40">
                <Crown size={28} className="text-psi-primary" />
            </div>
        </div>
    );
}
        ...
        <div className="min-h-screen bg-psi-page flex flex-col items-center justify-center p-4">
            ...
            <div className="w-full max-w-lg mb-6 flex flex-col items-center text-center">
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-amber-400 to-amber-600 flex items-center justify-center shadow-lg shadow-amber-500/20 mb-4">
                    <Crown size={26} className="text-psi-primary" />
                </div>
                ...
                {state === 'form' && (
                    ...
                    >
                        ...
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-2 py-4 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 disabled:from-psi-muted disabled:to-psi-muted text-psi-primary font-extrabold text-base rounded-2xl transition-all shadow-lg shadow-amber-500/20 disabled:shadow-none active:scale-[0.98] select-none"
                        >
                            <Zap size={18} />
                ...
                {state === 'assigned' && assignedAgent && (
                    ...
                    >
                        ...
                        <div className="psi-card p-6 border-2 border-emerald-500/40 text-center space-y-2">
                            ...
                            >
                                <Check size={28} className="text-psi-primary" />
                            </motion.div>
            ...
            <AnimatePresence>
                {activeAssignment && (
                    <motion.div
                        ...
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                        className="fixed inset-0 z-[9999] bg-psi-page flex flex-col items-center justify-center p-6 overflow-hidden"
                    >
                        ...
                        <div className="relative z-10 w-full max-w-sm flex flex-col items-center gap-6 text-center">
                            ...
                            >
                                ...
                                <h1 className="text-3xl font-black text-psi-primary tracking-tight leading-tight">
                            ...
                            <motion.div
                                ...
                                className="w-full bg-psi-subtle border border-psi rounded-3xl p-6 space-y-4"
                            >
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-left min-w-0">
                                        <p className="text-psi-secondary text-[10px] font-bold uppercase tracking-widest mb-0.5">Client Name</p>
                                        <p className="text-psi-primary text-xl font-extrabold truncate">{activeAssignment.clientName}</p>
                                    </div>
                                </div>

                                <div className="grid grid-cols-2 gap-3">
                                    <div className="bg-psi-subtle rounded-xl p-3 text-left">
                                        <p className="text-psi-muted text-[9px] font-bold uppercase tracking-widest mb-1">Language</p>
                                        <p className="text-psi-primary font-bold text-sm flex items-center gap-1.5">
                                            <Languages size={13} className="text-blue-400" />
                                            {activeAssignment.language}
                                        </p>
                                    </div>
                                    <div className="bg-psi-subtle rounded-xl p-3 text-left">
                                        <p className="text-psi-muted text-[9px] font-bold uppercase tracking-widest mb-1">Tier</p>
                                        <p className="text-psi-primary font-bold text-sm flex items-center gap-1.5">
                                            ...
                                            {activeAssignment.tier === 'Average' && <User size={13} className="text-psi-secondary" />}
                            ...
                            >
                                ...
                                <p className="text-amber-300 text-sm font-bold text-left">
                                    Please proceed to <span className="text-psi-primary">Reception</span> immediately to greet your VIP.
                                </p>
                            </motion.div>
                            ...
                            <motion.button
                                ...
                                className="w-full flex items-center justify-center gap-3 py-5 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-psi-primary font-extrabold text-lg rounded-2xl shadow-2xl shadow-amber-500/30 transition-all select-none disabled:opacity-70"
                            >
                                {acknowledging
                            ...
                            <p className="text-psi-muted text-xs">
