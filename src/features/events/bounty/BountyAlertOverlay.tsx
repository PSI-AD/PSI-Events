            ...
            >
                ...
                >
                    ...
                    <div className="relative flex items-center justify-center pt-8 pb-4">
                        ...
                        >
                            <Zap size={28} className="text-psi-primary fill-white" />
                        </motion.div>
                    </div>
                    ...
                    <div className="text-center px-6 pb-2">
                        ...
                        <motion.h2
                            ...
                            className="text-2xl font-extrabold text-psi-primary leading-tight"
                        >
                        ...
                        <motion.p
                            ...
                            className="text-psi-secondary text-sm mt-1"
                        >
                    ...
                    <div className="flex items-center justify-center gap-2 mb-5">
                        ...
                        <span className="text-xs text-psi-secondary font-medium">Window closes in</span>
                    ...
                    <div className="px-6 pb-8 space-y-3">
                        <motion.button
                            whileTap={{ scale: 0.97 }}
                            onClick={onClaim}
                            className="w-full py-4 rounded-2xl font-extrabold text-base text-psi-primary flex items-center justify-center gap-2 shadow-xl"
                        ...
                        <button
                            onClick={onDismiss}
                            className="w-full py-2.5 text-psi-secondary text-sm font-medium hover:text-psi-primary transition-colors"
                        >
