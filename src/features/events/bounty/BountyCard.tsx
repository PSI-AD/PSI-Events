            ...
            <div className="p-4 md:p-5">
                ...
                {bounty.status === 'claimed' && isOrganizer && onVerify && (
                    <motion.button
                        ...
                        className="w-full py-3 rounded-xl font-extrabold text-sm flex items-center justify-center gap-2 bg-blue-500 hover:bg-blue-600 text-white transition-all"
                    >
                        <ShieldCheck size={16} />
